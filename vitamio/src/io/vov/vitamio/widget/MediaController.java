...
public class MediaController extends FrameLayout {
  ...
  private View.OnClickListener mScreenListener = new View.OnClickListener() {
    public void onClick(View v) {
      doScreenResume();
      show(sDefaultTimeout);
    }
  ...
  public void setAnchorView(View view) {
    ...
    if (!mFromXml) {
      removeAllViews();
      mRoot = makeControllerView();//控制条视图
  ...
  private void initControllerView(View v) {
    ...
    mScreenButton = (ImageButton) v.findViewById(getResources().getIdentifier("mediacontroller_all_screen", "id", mContext.getPackageName()));
    if (mScreenButton != null) {
      mScreenButton.requestFocus();
      updateScreenPlay();
      mScreenButton.setOnClickListener(mScreenListener);
    }
  ...
  private void updateScreenPlay() {
    if (mRoot == null || mScreenButton == null)
      return;

    if (mContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT)
      //竖屏
      mScreenButton.setImageResource(getResources().getIdentifier("mediacontroller_small_screen", "drawable", mContext.getPackageName()));
    else
      //横屏
      mScreenButton.setImageResource(getResources().getIdentifier("mediacontroller_all_screen", "drawable", mContext.getPackageName()));
  }
